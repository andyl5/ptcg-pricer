...
function MainDeck() {  
  ...
  return (
    <div className='container'>
      ...
      <button onClick={handleSubmitDecklist}>Render the decklist</button>

      <div className='row'>
        <div className="col-8">
          <div className="row">
            <div className="col-6">
              <h1>Pokémon ({pokemonCards.length})</h1>
            ...
            <div className="col-6">
              <h1>Trainer ({trainerCards.length})</h1>
            ...
            <div className="col-6">
              <h1>Energy ({energyCards.length})</h1>
